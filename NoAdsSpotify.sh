...
# startingmsg=$(date +"%T >> 🔈 Songs are playing 😀🕺💃. Spotify volume back to normal")
# echo $startingmsg
# echo $(date +"%T >> 🔈 Songs are playing 😀🕺💃. Spotify volume back to normal")
        ...
        if [ $EVENT_PRESENT -eq 1 ]; then
            if grep -q -E "$AD_REG" <<< "$STREAM_LINE"; then
                ...
                if [ $MSG_AD_ECHOED -eq 0 ]; then
                    ...
                    # echo ">> 🔇 Ad found! Spotify volume is 0"
                    echo $(date +"%T >> 🔇 Ad found!                Spotify volume is zero.")
                fi
                ...
                if [ $MSG_SONG_PLAYING_ECHOED -eq 0 ]; then
                    ...
                    # echo ">> 🔈 Songs are playing 😀🕺💃. Spotify volume back to normal"
                    echo $(date +"%T >> 🔈 Songs are playing 😀🕺💃. Spotify volume is normal.")
